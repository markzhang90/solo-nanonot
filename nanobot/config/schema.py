...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.nanobot_new/workspace"
...
class AppsConfig(Base):
    ...
    reminder: ReminderAppConfig = Field(
        default_factory=lambda: _lazy_default("nanobot.apps.reminder.config", "ReminderAppConfig"),
    )
...
def _resolve_tool_config_refs() -> None:
    ...
    mod.ReminderAppConfig = ReminderAppConfig  # type: ignore[attr-defined]

    ToolsConfig.model_rebuild()
    AppsConfig.model_rebuild()
