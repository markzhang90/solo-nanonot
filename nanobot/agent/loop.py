...
class AgentLoop:
    ...
    def __init__(
        ...
        from nanobot.config.schema import AppsConfig, ToolsConfig

        _tc = tools_config or ToolsConfig()
        self.apps_config = apps_config or AppsConfig()
    ...
    def _register_default_tools(
        ...
        *,
        ...
        registered.extend(AppLoader(self.apps_config).load(ctx, self.tools))
