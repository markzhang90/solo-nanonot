...
| Create or refresh config | `nanobot onboard` | Creates `~/.nanobot_new/config.json` and `~/.nanobot_new/workspace/` |
...
| Path | Default |
|---|---|
| Config | `~/.nanobot_new/config.json` |
| Workspace | `~/.nanobot_new/workspace/` |
