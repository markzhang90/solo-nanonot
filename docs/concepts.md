...
The default instance lives under `~/.nanobot_new/`:

| Path | Meaning |
|---|---|
| `~/.nanobot_new/config.json` | Instance configuration: providers, model defaults, channels, tools, gateway, API, and runtime options |
| `~/.nanobot_new/workspace/` | Agent workspace: memory, sessions, heartbeat tasks, cron jobs, skills, and generated artifacts |
